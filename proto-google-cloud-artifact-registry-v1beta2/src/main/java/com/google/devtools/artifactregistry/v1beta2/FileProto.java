  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "to\032\037google/protobuf/timestamp.proto\032\034google/api/annotations.proto\"\217\001\n"
          + "\004Hash\022E\n"
          + "\004type\030\001"
          ...
          + "$artifactregistry.googleapis.com/File\022Hproj"
          + "ects/{project}/locations/{location}/repositories/{repo}/files/{file}\"Y\n"
          ...
          + ",com.google.devtools.artifactregistry.v1beta2B\tFileProto"
          + "P\001ZXgoogle.golang.org/genproto/googleapis/devtools/artifactregistry/v1beta2;arti"
          + "factregistry\252\002%Google.Cloud.ArtifactRegi"
          + "stry.V1Beta2\312\002%Google\\Cloud\\ArtifactRegi"
          + "stry\\V1beta2\352\002(Google::Cloud::ArtifactRegistry::V1beta2b\006proto3"
    };
    descriptor =
