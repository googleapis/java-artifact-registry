...
public final class VersionProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "6google/devtools/artifactregistry/v1beta2/version.proto\022(google.devtools.artifa"
          + "ctregistry.v1beta2\0322google/devtools/arti"
          + "factregistry/v1beta2/tag.proto\032\037google/p"
          + "rotobuf/timestamp.proto\032\034google/api/annotations.proto\"\323\001\n"
          + "\007Version\022\014\n"
          + "\004name\030\001 \001(\t\022\023\n"
          + "\013description\030\003 \001(\t\022/\n"
          + "\013create_time\030\005 \001(\0132\032.google.protobuf.Timestamp\022/\n"
          + "\013update_time\030\006 \001(\0132\032.google.protobuf.Timestamp\022C\n"
          + "\014related_tags\030\007"
          + " \003(\0132-.google.devtools.artifactregistry.v1beta2.Tag\"\221\001\n"
          + "\023ListVersionsRequest\022\016\n"
          + "\006parent\030\001 \001(\t\022\021\n"
          + "\tpage_size\030\002 \001(\005\022\022\n\n"
          + "page_token\030\003 \001(\t\022C\n"
          + "\004view\030\004 \001(\01625.google.devtools.artifactregistry.v1beta2.VersionView\"t\n"
          + "\024ListVersionsResponse\022C\n"
          + "\010versions\030\001"
          + " \003(\01321.google.devtools.artifactregistry.v1beta2.Version\022\027\n"
          + "\017next_page_token\030\002 \001(\t\"f\n"
          + "\021GetVersionRequest\022\014\n"
          + "\004name\030\001 \001(\t\022C\n"
          + "\004view\030\002 \001(\01625.google.devtools.artifactregistry.v1beta2.VersionView\"3\n"
          ...
          + ",com.google.devtools.artifactregistry.v1beta2B\014VersionProtoP\001ZXgoogle.golang.org"
          + "/genproto/googleapis/devtools/artifactregistry/v1beta2;artifactregistry\252\002%Google"
          + ".Cloud.ArtifactRegistry.V1Beta2\312\002%Google"
          + "\\Cloud\\ArtifactRegistry\\V1beta2\352\002(Google"
          + "::Cloud::ArtifactRegistry::V1beta2b\006proto3"
    };
    descriptor =
